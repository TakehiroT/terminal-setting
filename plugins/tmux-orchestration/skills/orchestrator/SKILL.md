...
tmux send-keys -t ide:Impl.2 'tmux-reviewer skillを使って /review .branches/<feature>/ を行なってください' Enter
```
...
# codex（レビュワー）ペインにメッセージ送信
tmux send-keys -t ide:Impl.2 'メッセージ' Enter
