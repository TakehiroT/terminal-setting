...
local function setup(st, opts)
	...
	local t = th.git or {}
	local colors = {
		[CODES.ignored] = t.ignored_fg or "darkgray",
		[CODES.untracked] = t.untracked_fg or "magenta",
		[CODES.modified] = t.modified_fg or "yellow",
		[CODES.added] = t.added_fg or "green",
		[CODES.deleted] = t.deleted_fg or "red",
		[CODES.updated] = t.updated_fg or "yellow",
	}
	local signs = {
	...
	Linemode:children_add(function(self)
		...
		if not code or signs[code] == "" then
			...
			return ui.Line { " ", ui.Span(signs[code]):fg(colors[code]) }
		end
	end, opts.order)
	...
	Entity.style = function(self)
		...
		if code and colors[code] then
			return style:fg(colors[code])
		end
		return style
	end
end
